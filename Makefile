...
# Nome do executable
OUTPUT = analizadorLexicoD

# Ficheiros .h
LIB_HEADERS = definiciones.h lexico.h sintactico.h sistemaEntrada.h tablaSimbolos.h abb.h errores.h

# Ficheiros .c
SRCS = main.c lexico.c sintactico.c sistemaEntrada.c tablaSimbolos.c abb.c errores.c
